    ...
    <body>
        ...
        <header>
                    ...
                    <nav class="limiter-menu-desktop container">
                        ...
                        <div class="menu-desktop">
                            <ul class="main-menu">
                                ...
                                <li>
                                    <a href="<%=(username == null) || (username == "") ? "login" : ""%>"><%=(username == null) || (username == "") ? "Login" : "Hi, " + username%></a>
            ...
            <div class="menu-mobile">
                <ul class="main-menu-m">
                    ...
                    <li>
                        <%=username == null ? "Login" : "Hi, " + username%></a>
                    </li>
                </ul>
            </div>
        ...
        <div class="wrap-header-cart js-panel-cart">
            ...
            <div class="header-cart flex-col-l p-l-65 p-r-25">
                ...
                <div class="header-cart-content flex-w js-pscroll"></div>
